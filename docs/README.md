...
| Compaction dogfood | [Compaction live dogfood](compaction-live-dogfood.md) | Stage 6/6.1/6.2 live smoke and extended dogfood: direct backend runbook, v3 reliability/quality confirmed, latency baseline, fallback proven. |
