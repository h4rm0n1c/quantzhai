...
| Operational state | [Operational store design](operational-store-design.md) | #51/#46 Slice A-design: OperationalStore boundary, schema, session/workspace identity, qz-write-runtime-state replacement, recovery persistence, repeated-read v2 dependency, safety rules, slice roadmap. |
