...
18. [Compaction audit and strategy](compaction-audit-and-strategy.md) — source-grounded audit of Codex and QuantZhai compaction, issue #8 promoted ideas, anchored summary schema v0, recommended prompt v0, and staged implementation roadmap. Stage 6.9.
...
21. [Compaction live dogfood](compaction-live-dogfood.md) — Stage 6/6.1 direct-backend smoke runbook, live evidence, observed v2 fallback, and accepted opt-in v3 tuning. Stage 6.9.
...
23. [Stage 6.8/6.9 compaction corpus coverage and budget alignment](compaction-stage68-coverage.md) — coverage/runner hardening (13/14 v3 accepted, c_macro confirmed), plus Stage 6.9 context-aligned budget resolver design and test summary.
...
| Compaction coverage | [Stage 6.8/6.9 compaction corpus coverage and budget alignment](compaction-stage68-coverage.md) | Stage 6.8: targeted file selection, full artifacts, 13/14 v3, c_macro confirmed. Stage 6.9: context-aligned budget resolver, 59 tests. |
