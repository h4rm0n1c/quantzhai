...
23. [Stage 6.8 compaction corpus coverage](compaction-stage68-coverage.md) — coverage/runner hardening pass: targeted file selection, full artifact preservation, 13/14 v3 accepted, c_macro confirmed, Go/C++/C coverage achieved, fmt deep fallback characterised.
...
| Compaction coverage | [Stage 6.8 compaction corpus coverage](compaction-stage68-coverage.md) | Coverage/runner hardening: targeted file selection, full artifact preservation, 13/14 v3, c_macro confirmed, Go/C++/C coverage, fmt deep fallback. |
