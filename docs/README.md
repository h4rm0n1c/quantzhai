...
| Compaction dogfood | [Compaction live dogfood](compaction-live-dogfood.md) | Stage 6/6.1/6.2/6.3 live smoke and extended dogfood: direct backend runbook, v3 reliability/quality confirmed, latency baseline, fallback proven, corpus staging harness. |
| Compaction corpus | [Compaction corpus dogfood](compaction-corpus-dogfood.md) | Stage 6.4: multi-repo staging harness for anti-overfit compaction testing. 8 repos, 4 scripts, 47 tests. |
