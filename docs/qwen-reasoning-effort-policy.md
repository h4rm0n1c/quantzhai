...
| --- | --- | --- | --- |
| `low` | Fast/shallow effort. Good for simple prompts. | `temperature=0.7`, `top_p=0.8`, `top_k=20`, `presence_penalty=1.5` | `Use low reasoning effort. Think briefly.` |
| `medium` | Default coding-agent balance. | `temperature=0.6`, `top_p=0.95`, `top_k=20`, `presence_penalty=0` | `Use medium reasoning effort. Balance speed and correctness.` |
| `high` | Careful reasoning for complex work. | `temperature=1.0`, `top_p=0.95`, `top_k=20`, `presence_penalty=1.5` | `Use high reasoning effort. Reason carefully before acting.` |
| `xhigh` | Deep effort when complexity warrants it. | Same as `high` | `Use extra-high reasoning effort. Explore deeply when complexity warrants it.` |
