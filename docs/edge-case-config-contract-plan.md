...
6. **Slice D-design: A2/A3 migration plan** — assess coupling, define compatibility for moving `var/codex-home/model-catalogs/` and `var/codex-home/config.toml` together
7. **Slice E: var/codex-home/config.toml decision** — deprecate or keep as server-internal view; no client impact after #58
