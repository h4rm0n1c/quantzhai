...
```text
P1 #37 Stream seam extraction (Slices 1–2H.1 complete) — next: design micro-slice before any further extraction
...
1. **#37 design micro-slice** — next seam. Slices 1–2H.1 complete; design before any further extraction.
